...
urlpatterns = [
    ...
    path('enroll/api/grade-registration/toggle/', views.api_toggle_grade_registration, name='api_toggle_grade_registration'),
    path('enroll/api/grade-registration/bulk/', views.api_bulk_grade_registration, name='api_bulk_grade_registration'),
