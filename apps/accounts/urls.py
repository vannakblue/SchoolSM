...
urlpatterns = [
    ...
    path('settings/gemini-ai/', views.gemini_settings_view, name='gemini_settings'),
    path('api/gemini/test-key/', views.api_gemini_test_key, name='api_gemini_test_key'),
    ...
    path('api/ai-translate/', views.api_ai_translate_text, name='api_ai_translate_text'),
