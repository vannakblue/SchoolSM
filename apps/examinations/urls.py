...
urlpatterns = [
    ...
    path('academic-booklets/', views.academic_booklets_hub_view, name='academic_booklets_hub'),
    ...
    path('homeroom/<int:classroom_id>/individual-tracking-books/', views.homeroom_individual_tracking_books_batch_view, name='homeroom_individual_tracking_books_batch_view'),
    path('homeroom/<int:classroom_id>/conduct-assessment/', views.homeroom_conduct_assessment_view, name='homeroom_conduct_assessment_view'),
    path('homeroom/<int:classroom_id>/conduct-assessment/page/', views.homeroom_conduct_assessment_view, name='homeroom_conduct_assessment'),
    path('students/<int:student_id>/tracking-book/', views.student_study_tracking_book_view, name='student_study_tracking_book_view'),
    ...
    path('api/conduct-assessment/save/', views.api_save_student_conduct_assessment, name='api_save_student_conduct_assessment'),
