...
urlpatterns = [
    ...
    # 9. Student Registration, Directory & ID Uniqueness APIs
    ...
    path('students/registration-period/', views.MobileStudentRegistrationPeriodAPIView.as_view(), name='mobile_api_registration_period'),
