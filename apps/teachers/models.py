...
class Teacher(models.Model):
    ...
    phone = models.CharField(max_length=50, verbose_name="លេខទូរស័ព្ទចម្បង / Primary Phone")
    phone2 = models.CharField(max_length=50, blank=True, null=True, verbose_name="លេខទូរស័ព្ទទី២ / Secondary Phone")
