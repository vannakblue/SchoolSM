...
INSTALLED_APPS = [
    ...
    # Cloud Storage (Persistent Media)
    'cloudinary_storage',
    'cloudinary',
]
...
MIDDLEWARE = [
    ...
    'school_management.middleware.ActiveLanguageMiddleware',
...
# Cloudinary Configuration for Media Storage (Persistent across Render deployments)
...
GEMINI_API_KEYS = os.environ.get('GEMINI_API_KEYS', '')  # Comma-separated keys for auto-rotation
