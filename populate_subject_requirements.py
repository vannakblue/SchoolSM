...
subjects_to_ensure = [
    ...
    ('M', 'គណិតវិទ្យា', 'Mathematics', '#dc2626', 4),
    ('P', 'រូបវិទ្យា', 'Physics', '#8b5cf6', 5),
    ('C', 'គីមីវិទ្យា', 'Chemistry', '#10b981', 6),
    ('B', 'ជីវវិទ្យា', 'Biology', '#14b8a6', 7),
    ('Es', 'ផែនដីវិទ្យា', 'Earth Science', '#84cc16', 8),
    ('I', 'សីលធម៌', 'Civics & Moral', '#06b6d4', 9),
    ('G', 'ភូមិវិទ្យា', 'Geography', '#d97706', 10),
    ('H', 'ប្រវត្តិវិទ្យា', 'History', '#f59e0b', 11),
